        ...
        <div className="bed-box">
          <div className="stat-panel-box">
            ...
            >
              <div className="overall-stats">
                ...
                <CountUp
                  start={0}
                  end={displayStat("losses_bedwars")}
                  delay={0}
                  duration={1.4}
                  decimals={0}
                  separator={","}
                ...
                <CountUp
                  start={0}
                  end={getRatio("wins_bedwars", "games_played_bedwars") * 100}
                  delay={0}
                  duration={1.5}
                  decimals={1}
                >
                ...
                <CountUp
                  start={0}
                  end={displayStat("final_kills_bedwars")}
                  delay={0}
                  duration={1.4}
                  decimals={0}
                  separator={","}
                ...
                <CountUp
                  start={0}
                  end={displayStat("final_deaths_bedwars")}
                  delay={0}
                  duration={1.4}
                  decimals={0}
                  separator={","}
                ...
                <CountUp
                  start={0}
                  end={getRatio("final_kills_bedwars", "final_deaths_bedwars")}
                  delay={0}
                  duration={1.4}
                  decimals={2}
                >
                ...
                <CountUp
                  start={0}
                  end={displayStat("beds_broken_bedwars")}
                  delay={0}
                  duration={1.4}
                  decimals={0}
                  separator={","}
                ...
                <CountUp
                  start={0}
                  end={displayStat("beds_lost_bedwars")}
                  delay={0}
                  duration={1.4}
                  separator={","}
                >
                ...
                <CountUp
                  start={0}
                  end={getRatio("beds_broken_bedwars", "beds_lost_bedwars")}
                  delay={0}
                  duration={1.4}
                  decimals={2}
                >
          ...
          <div className="stats-tabs">
            <div>
              <button
                onClick={handleClick}
                className={`button button--primary button--large bedwars ${
                  tab === 1 ? "active" : ""
                }`}
                value="1"
              >
            ...
            <div>
              <div className="gamemode-stat" style={{ paddingTop: "35px" }}>
                <p className="alignleft" style={{ fontSize: "50px" }}>
                  <CountUp
                    start={0}
                    end={displayStat(tabGamemodeID[tab - 1] + "wins_bedwars")}
                    delay={0}
                    duration={0.5}
                    separator={","}
                  />
                ...
                <p className="aligncenter" style={{ fontSize: "50px" }}>
                  <CountUp
                    start={0}
                      ...
                      tabGamemodeID[tab - 1] + "final_kills_bedwars"
                    )}
                    delay={0}
                    duration={0.5}
                    separator={","}
                ...
                <p className="alignright" style={{ fontSize: "50px" }}>
                  <CountUp
                    start={0}
                      ...
                      tabGamemodeID[tab - 1] + "beds_broken_bedwars"
                    )}
                    delay={0}
                    duration={0.5}
                    separator={","}
              ...
              <div
                className="gamemode-stat-labels"
                ...
                <p className="alignleft" style={{ fontSize: "50px" }}>
                  <CountUp
                    start={0}
                      ...
                      tabGamemodeID[tab - 1] + "games_played_bedwars"
                    )}
                    delay={0}
                    duration={0.5}
                    separator={","}
                ...
                <p className="aligncenter" style={{ fontSize: "50px" }}>
                  <CountUp
                    start={0}
                      ...
                      tabGamemodeID[tab - 1] + "final_deaths_bedwars"
                    )}
                    delay={0}
                    duration={0.5}
                    separator={","}
                ...
                <p className="alignright" style={{ fontSize: "50px" }}>
                  <CountUp
                    start={0}
                      ...
                      tabGamemodeID[tab - 1] + "beds_lost_bedwars"
                    )}
                    delay={0}
                    duration={0.5}
                    separator={","}
              ...
              <div
                className="gamemode-stat"
                style={{ paddingTop: "35px", color: "#D12A6F" }}
              >
                <p className="alignleft" style={{ fontSize: "50px" }}>
                  <CountUp
                    start={0}
                      ...
                      getRatio(
                        tabGamemodeID[tab - 1] + "wins_bedwars",
                        tabGamemodeID[tab - 1] + "games_played_bedwars"
                      ) * 100
                    }
                    delay={0}
                ...
                <p
                  ...
                  style={{ fontSize: "50px", color: "#D12A6F" }}
                >
                  <CountUp
                    start={0}
                    end={getRatio(
